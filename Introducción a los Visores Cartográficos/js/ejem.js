...
(function() {
  ...
  $(document).ready(function () {
    ...
    var estacion_san_antonio = L.marker([6.247177, -75.569686])
                                  .addTo(map)
                                  .bindPopup("<b>Estación San Antonio</b>");
    ...
    var estadio = L.geoJSON(geojson_estadio)
                  .addTo(map)
                  .bindPopup("<b>Estadio Atanasio Girardot</b>");
